<template>
    <div class="container">
        ...
        <div class="w-100 border-bottom d-flex justify-content-between">
            ...
            <button id="crearSlider" @click="crearSlider()" type="button" class="btn mb-1"
...
<p>Video</p>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-sm btn-danger" style="margin-left: 15px; " @click="eliminarSlider(slider.id)">
