        ...
        <table class="table table-bordered mt-3">
            ...
            <tbody>
                <tr v-for="servicio in servicios" :key="servicio.id">
                    <th>{{ servicio.orden }}</th>
                    <td>
                        <div v-html="servicio.texto"></div>
                    </td>
                    <th><div v-html="servicio.icono"></div></th>
                    <td>
                        <button type="button" class="btn btn-sm" style="background-color: rgb(52, 68, 127);"
                            @click="editarServicio(22, servicio.id)">
                        ...
                        <button type="button" class="btn btn-sm btn-danger" style="margin-left: 15px; " @click="deleteServicio(servicio.id)">
